...
export default function Generator(props) {
    ...
    return (
        <SectionWrapper id={'generate'} header={"generate your workout"} title={['It\'s', 'Huge', 'o\'clock']}>
            <Header index='01' title="Pick your poison" description="Select the workout you whisk to endure" />
            ...
            <Header index='02' title="Lock on targets" description="Select the muscles judged annihilation" />
            <div className="bg-slate-950 border border-blue-400 rounded-lg relative flex flex-col">
            ...
            <button className="px-8 mx-auto py-4 bg-slate-950 border-[2px] border-blue-400 rounded-md border-solid blueShadows duration-200">Formulate</button>
        </SectionWrapper>
    )
}